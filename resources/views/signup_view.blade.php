...
<div class="row">
    <div class="col-md-8 offset-md-2">
      <h1 class="display-4 text-center my-5 mb-n1">Registrar Usuarios</h1>
      <div class="text-center ">
		  <p class="lead">Complete los campos para registrar un nuevo usuario.</p>
      </div>
    </div>
  </div>
            ...
            <div class="form-holder">
                <div class="form-content">
                    <div class="form-items">
                        ...
                        <form class="requires-validation" action="/signup" method="post">
                        @csrf 
                            <div class="col-md-12 text-dark">
                               <input class="form-control" name="usuario_registro" type="text" id="Username" placeholder="Usuario">
                               <div class="valid-feedback">ID valido</div>
                               <div class="invalid-feedback">El Id del usuario no puede queadar vacio!</div>
                            </div>

                            <div class="col-md-12 text-dark">
                                <input class="form-control" name="contraseña_registro" type="text" maxlength="40" id="Username" placeholder="Pass">
                                 <div class="valid-feedback">Nombre Valido</div>
                                 <div class="invalid-feedback">El nombre es invalido!</div>
                            </div>                                      

                            <div class="col-md-12 mt-3">
                                <label class="mb-3 mr-1" for="tipo_registro">Tipo: </label>

                                <input type="radio" class="btn-check" name="tipo_registro" id="administrador" autocomplete="off" value="Administrador">
                                <label class="btn btn-sm btn-outline-secondary" for="administrador">Administrador</label>

                                <input type="radio" class="btn-check" name="tipo_registro" id="standard" autocomplete="off" value="Standard">
