...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
  ...
  <div class="row">
    <div class="col-md-8 offset-md-2">
      <h1 class="display-4 text-center my-5">Canasta Inteligente</h1>
      <div class="text-center mb-5">
		  <p class="lead">Ingresa el nombre con el que se identificara la canasta y el tiempo que cubriran los productos y te recomendaremos que productos incluir.</p>
      </div>
    </div>
  </div>
                ...
                <div class="form-holder">
                    <div class="form-content">
                        <div class="form-items">
                            ...
                            <form class="requires-validation" action="/smart_basket_view" method="post">
                            @csrf 
                                ...
                                @else
                                <div class="col-md-12 text-dark">
                                    <input class="form-control" name="nombre_canasta" type="text" readonly required="required" maxlength="20" id="nombreCanasta" placeholder="Nombre Canasta">
                                    <div class="valid-feedback">Nombre válido</div>
                                    <div class="invalid-feedback">El nombre de la canasta no puede quedar vacío.</div>
                                </div><br>

                                <div class="col-md-12 text-dark">
                                    <input class="form-control" name="tiempo_canasta" type="number" readonly required="required" maxlength="2" id="tiempoCanasta" placeholder="Días" min="1" max="64">
                                    <div class="valid-feedback">Tiempo válido</div>
                                    <div class="invalid-feedback">El tiempo es inválido.</div>
                                </div>

                                <div class="form-button mt-3 text-dark">
                                    <button id="submit" type="submit" class="btn btn-primary" disabled>Enviar</button>
                                </div>
                                                                @endif
                            </form>
                        </div>
